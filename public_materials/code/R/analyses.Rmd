...
#show number of trials per participant
n_trials.ex1_followup <- df.ex1.trials %>% 
  filter(
   !ego_can_infer
  ) %>% 
  count(workerid) %>% 
...
#show number of trials per participant
n_trials.ex2a_followup <- df.ex2a.trials %>% 
  filter(
    !ego_can_infer
  ) %>% 
  count(workerid) %>% 
  summarise(avg_trials = mean(n))
n_trials.ex2a_followup
```
...
#show number of trials per participant
n_trials.ex2b_followup <- df.ex2b.trials %>% 
  filter(
    !ego_can_infer
  ) %>% 
  count(workerid) %>% 
  summarise(avg_trials = mean(n))
n_trials.ex2b_followup
```
...
#show number of trials per participant
n_trials.ex2c_followup <- df.ex2c.trials %>% 
  filter(
    !ego_can_infer
  ) %>% 
  count(workerid) %>% 
