...
ggsave(filename = "../../figures/plots/control_alter_knowledge.pdf",
       width = 8,
       height = 4)
```
...
ggsave(filename = "../../figures/plots/exp3_alter_knowledge.pdf",
       width = 8,
       height = 4)
```
...
ggsave(filename = "../../figures/plots/exp5_alter_knowledge.pdf",
       width = 8,
       height = 4)
```
